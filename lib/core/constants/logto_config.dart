...
class LogtoConfig {
  ...
  static const String clientId = 'qe2bhb5xygpcy8vy4a673'; // Get from Logto Dashboard
  static const String appScheme = 'ewarga.logto'; // Custom redirect scheme for Flutter
  static const String redirectUrl = 'ewarga.logto://callback'; // OAuth redirect URL
